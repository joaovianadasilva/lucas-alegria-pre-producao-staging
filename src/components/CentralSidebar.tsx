...
import { Wallet, Undo2, BarChart3, ArrowLeft, ShieldCheck, FileText, FileBarChart, Settings2 } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive('/central/relatorios/visao-geral-receita')}>
                  <NavLink to="/central/relatorios/visao-geral-receita" className={cls}>
                    <FileBarChart className="h-4 w-4" />
                    {!collapsed && <span>Visão Geral de Receita</span>}
                  </NavLink>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive('/central/regras')}>
                  <NavLink to="/central/regras" className={cls}>
                    <Settings2 className="h-4 w-4" />
                    {!collapsed && <span>Regras Operacionais</span>}
                  </NavLink>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
